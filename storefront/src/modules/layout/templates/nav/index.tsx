...
export async function NavigationHeader() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 group bg-white text-zinc-900 h-[75px] small:px-4 px-2 text-sm border-b duration-200 border-ui-border-base z-50 flex items-center">
